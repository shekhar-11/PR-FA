  ...
  return (
    <div className="w-5/6 bg-gray-50 flex justify-center items-center p-8">
      ...
      <div className="relative z-20 max-w-4xl w-full bg-white rounded-lg shadow-md p-6 transition-all duration-300">
        <h1 className="text-2xl font-bold text-gray-800 mb-6 text-center">Part B</h1>

        <div className="flex flex-col items-center">
          <div className="flex items-center gap-3 mb-4">
            <h2 className="text-lg font-semibold text-gray-700">Resolution</h2>
            <button
              onClick={toggleSection}
              className="p-2 hover:bg-gray-100 rounded-lg transition-colors"
              title="Toggle resolution details"
            >
              <svg
